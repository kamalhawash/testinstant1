...
<div class="d-flex align-items-center justify-content-between">
  <a href="/testinstant/" class="logo d-flex align-items-center">
    <img src="/testinstant/assets/img/logo.png" alt="">
    <span class="d-none d-lg-block">Easy Admin</span>
  </a>
  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
        <img src="/testinstant/admin/upload/<?= $_SESSION['image'] ?>"  class="rounded-circle">
